...
// Route for scantrust page (/scantrust and /scantrust/)
app.get(['/scantrust', '/scantrust/', '/projects/scantrust', '/projects/scantrust/'], (req, res) => {
  res.sendFile(path.join(__dirname, 'projects', 'scantrust.html'));
});
